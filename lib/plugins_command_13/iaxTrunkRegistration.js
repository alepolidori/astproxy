 ...
 * @final
 * @readOnly
 * @default [iaxTrunkRegistration]
 */
var IDLOG = '[iaxTrunkRegistration]';
...
(function () {
  ...
  try {
    ...
    /**
     * Command plugin to get the iax trunk registration.
     *
     * Use it with _astproxy_ module as follow:
     *
     *     astproxy.doCmd({ command: 'iaxTrunkRegistration', trunk: '3001' }, function (res) {
     *         // some code
     *     });
     *
     * @class iaxTrunkRegistration
     * @static
     */
    var iaxTrunkRegistration = {
      ...
      execute: function (am, args, cb) {
        try {
          ...
          act.ActionID = action.getActionId('iaxTrunkRegistration');
    ...
    // public interface
    exports.data = iaxTrunkRegistration.data;
    exports.execute = iaxTrunkRegistration.execute;
    exports.setLogger = iaxTrunkRegistration.setLogger;
