...
(function() {
  ...
  try {
    ...
    /**
     * Command plugin to park a call.
     *
     * Use it with _astproxy_ module as follow:
     *
     *     ast_proxy.doCmd({ command: 'parkChannel', chToPark: 'SIP/214-00000', chToReturn: 'SIP/221-00000' }, function (res) {
     *         // some code
     *     });
     *
     *
    ...
    var parkChannel = {
      ...
      /**
       * Execute asterisk action to park a call.
       *
       * @method execute
      ...
      execute: function(am, args, cb) {
        try {
          ...
          var act = {
            Action: 'Park',
            Channel: args.chToPark,
            Channel2: args.chToReturn
          };

          // set the action identifier
          act.ActionID = action.getActionId('parkChannel');
    ...
    // public interface
    exports.data = parkChannel.data;
    exports.execute = parkChannel.execute;
