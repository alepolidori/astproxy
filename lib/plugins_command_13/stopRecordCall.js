 ...
 * @final
 * @readOnly
 * @default [stopRecordCall]
 */
var IDLOG = '[stopRecordCall]';
...
(function() {
  ...
  try {
    ...
    var stopRecordCall = {
      ...
      /**
       * Execute asterisk action to stop the recording of a call.
       *
       * @method execute
      ...
      execute: function(am, args, cb) {
        try {
          ...
          act.ActionID = action.getActionId('stopRecordCall');
    ...
    // public interface
    exports.data = stopRecordCall.data;
    exports.execute = stopRecordCall.execute;
    exports.setLogger = stopRecordCall.setLogger;
