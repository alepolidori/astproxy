...
(function() {
  ...
  try {
    ...
    /**
     * Command plugin to set the CF on unavailable to voicemail status of an extension.
     *
     * Use it with _astproxy_ module as follow:
     *
     *     astproxy.doCmd({ command: 'cfuVmSet', exten: '214', val: '214' }, function (res) {
     *         // some code
     *     });
     *
     * @class cfuVmSet
    ...
    var cfuVmSet = {
      ...
      /**
       * Execute asterisk action to set the CF on unavailable to voicemail status.
       *
       * @method execute
      ...
      execute: function(am, args, cb) {
        try {
          ...
          if (args.activate) {
            ...
            // call forward on unavailable to voicemail sets the CF property of the asterisk database as
          ...
          act.ActionID = action.getActionId('cfuVmSet');
    ...
    // public interface
    exports.data = cfuVmSet.data;
    exports.execute = cfuVmSet.execute;
    exports.setLogger = cfuVmSet.setLogger;
