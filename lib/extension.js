...
exports.Extension = function(ext, chType) {
  ...
  function toJSON(privacyStrOutQueue, privacyStrInQueue) {
    ...
    return {
      ip: ip,
      cf: privacyStrOutQueue ? (cf.slice(0, -privacyStrOutQueue.length) + privacyStrOutQueue) : cf,
      mac: mac,
      cfb: privacyStrOutQueue ? (cfb.slice(0, -privacyStrOutQueue.length) + privacyStrOutQueue) : cfb,
      cfu: privacyStrOutQueue ? (cfu.slice(0, -privacyStrOutQueue.length) + privacyStrOutQueue) : cfu,
      dnd: dnd,
      cfVm: cfVm,
      port: port,
      name: name,
