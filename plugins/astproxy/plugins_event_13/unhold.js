...
(function() {
  ...
  try {
    /**
     * The plugin that handles the Unhold event.
     *
     * @class unhold
     * @static
     */
    var unhold = {
       ...
       * Unhold event received from the asterisk.
       *
       * @method data
        ...
        try {
          if (data.channel && data.calleridnum && data.connectedlinenum && data.event === 'Unhold') {
            ...
            astProxy.proxyLogic.evtConversationUnhold({
              ...
              whoPutsOnUnhold: data.calleridnum,
              putOnUnhold: data.connectedlinenum
            });
          }
        } catch (err) {
    ...
    // public interface
    exports.data = unhold.data;
    exports.visit = unhold.visit;
