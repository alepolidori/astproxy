...
(function() {
  ...
  try {
    ...
    /**
     * Command plugin to set the CF on busy to voicemail status of an extension.
     *
     * Use it with _astproxy_ module as follow:
     *
     *     astproxy.doCmd({ command: 'cfbVmSet', exten: '214', val: '214' }, function (res) {
     *         // some code
     *     });
     *
     * @class cfbVmSet
    ...
    var cfbVmSet = {
      ...
      /**
       * Execute asterisk action to set the CF on busy to voicemail status.
       *
       * @method execute
      ...
      execute: function(am, args, cb) {
        try {
          ...
          if (args.activate) {
            ...
            // call forward on busy to voicemail sets the CF property of the asterisk database as
          ...
          act.ActionID = action.getActionId('cfbVmSet');
    ...
    // public interface
    exports.data = cfbVmSet.data;
    exports.execute = cfbVmSet.execute;
    exports.setLogger = cfbVmSet.setLogger;
